...
const changeModalState = state => {
  //Функция записи значений в обьект 
  ...
  function bindActionToElems(event, elemm, prop) {
    elemm.forEach((item, i) => {
...
const checkNumInputs = selector => {
  // функция для ввода в инпут только цифры
...
const timer = (id, deadline) => {
  ...
  const getTimeRamaining = endtime => {
