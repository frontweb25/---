...
const forms = () => {
  const form = document.querySelectorAll('form'),
        ...
        phoneUnputs = document.querySelectorAll('input[name="user_phone"]');
  phoneUnputs.forEach(item => {
  ...
  const message = {
    loading: 'Зарузка',
    success: 'Спасибо! Скоро мы с вамим свяжемся',
...
const tabs = (headerSelector, tabSelector, contentSelector, activeClass) => {
  ...
  header.addEventListener('click', e => {
    ...
    if (target && target.classList.contains(tabSelector) || target.parentNode.classList.contains(tabSelector.replace(/\./, ''))) {
      tab.forEach((item, i) => {
